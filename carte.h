...
/**
 * Deux autres fonctions à ajouter, une fonction permettant d'alleger le main en prenant la touche appuyé et faisant les actions
 * qu'il faut, l'autre fonction sra utilisée dans celle-ci pour la comparaison (Si la fonction de base devient trop grande)
*/
//Cette fonction remplace la gestion des inputs dans le main, elle renvoie la valeur que chronoCompare doit prendre en fonction
//des comparaisons à faire/faites
double ManageInput(Carte * deck,Carte * compared,Carte * current_focus,bool * freezeInput,double * elapsed_time,double * chronoCompare);
