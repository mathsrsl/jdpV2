...
void results(WINDOW * resultBox, float temps, bool game){
    ...
    if (fichier == NULL){
        ...
        wclear(resultBox);
        mvwprintw(resultBox, 1, 1, "VICTOIRE");
        mvwprintw(resultBox, 1, 2, "Meilleur chrono :");
        mvwprintw(resultBox, 1, 3, "1 %s %s", nom1, score1);
        mvwprintw(resultBox, 1, 4, "2 %s %s", nom2, score2);
        mvwprintw(resultBox, 1, 5, "3 %s %s", nom3, score3);
    }*/
}
